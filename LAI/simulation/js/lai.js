...
function Slide(title, background, latitude, longitude,gapFraction, openness, laiLin1, laiLin2, laiLog1, laiLog2) {
	this.title = title;
...
function displayTable(){
	document.getElementById("name").innerHTML = `Sample: ${setVariable.title}`
